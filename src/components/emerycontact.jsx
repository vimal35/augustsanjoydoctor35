        ...
        <div className="emc-card">
          <div className="emc-content">
            ...
            <h2 className="emc-title">
              {"Need Immediate Medical Assistance?".split(" ").map((w, i) => (
                <span className="emc-word" key={i}><span>{w}</span></span>
              ))}
            </h2>

            <p className="emc-subtitle">
              Our specialist care team is available round-the-clock. Reach out instantly for urgent consultations, home visits, or appointment bookings — we're here whenever you need us.
            </p>
          ...
          <div className="emc-actions">
            <a href="tel:+919944969049" className="emc-btn emc-btn-call">
              ...
              <span className="emc-btn-text"><span className="emc-btn-label">Call Now</span><span className="emc-btn-value">+91 99449 69049</span></span>
            </a>

            <a href="https://wa.me/919944969049" target="_blank" rel="noopener noreferrer" className="emc-btn emc-btn-whatsapp">
              <span className="emc-btn-icon">
              ...
              <span className="emc-btn-text"><span className="emc-btn-label">WhatsApp</span><span className="emc-btn-value">+91 99449 69049</span></span>
            </a>
          </div>
        </div>
      </div>
